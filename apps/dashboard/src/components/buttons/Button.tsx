...
const Button: React.FC<ButtonProps> = ({
  ...
  const colorClasses: Record<Color, Record<Variant, string>> = {
    ...
    error: {
      ...
      outline: 'border-red-600 text-red-600 hover:bg-red-50 hover:text-red-700 focus:ring-red-500',
    ...
    info: {
      ...
      ghost: 'text-cyan-600 hover:bg-cyan-50 hover:text-cyan-700 focus:ring-cyan-500',
    ...
    warning: {
      ...
      ghost: 'text-amber-600 hover:bg-amber-50 hover:text-amber-700 focus:ring-amber-500',
