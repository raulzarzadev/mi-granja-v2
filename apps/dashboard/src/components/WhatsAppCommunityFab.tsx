...
const WHATSAPP_URL = 'https://whatsapp.com/channel/0029Vb7yj5l9Bb61XqL21i2x'
...
export default function WhatsAppCommunityFab() {
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-[#25D366] hover:bg-[#1da851] text-white font-semibold shadow-2xl ring-1 ring-black/10 px-4 py-3 transition-all cursor-pointer print:hidden"
